        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-400">
              We provide immediate assistance to communities affected by natural disasters and humanitarian crises
              worldwide.
            </p>
          ...
          <div>
            ...
            <p className="text-slate-400 mb-4">
              Subscribe to our newsletter for updates on our relief efforts and ways to help.
            </p>
          ...
          <div className="flex flex-wrap justify-center gap-8 items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <div className="text-xs text-slate-400">Platinum Transparency</div>
              </div>
            </div>
            <div className="flex items-center gap-2">
              <div className="h-12 w-12 rounded-full bg-slate-800 flex items-center justify-center">
      ...
      <div className="bg-slate-950 py-6">
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <div className="text-slate-500 text-sm">© {new Date().getFullYear()} Relief Fund. All rights reserved.</div>
