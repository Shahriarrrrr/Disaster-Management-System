...
const Chatbot = () => {
  ...
  const disasterPrompts = [
    ...
    },
    {
      ...
      prompt:
        "Help me create a comprehensive disaster preparedness plan for my family",
    ...
    },
    {
      ...
      prompt:
        "What emergency contacts and communication plans should I have ready?",
            ...
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-red-100">
                  Emergency Response & Disaster Management Assistant
                </p>
              </div>
            </div>
            ...
            {messages.length === 0 && (
              <div className="text-center py-12">
                ...
                <p className="text-slate-400 text-lg">
                  Select a topic above or ask me anything about emergency
                  preparedness
                </p>
              </div>
            )}
          ...
          <div className="border-t border-slate-700 p-6">
            ...
            <div className="mt-4 text-center">
              <p className="text-xs text-slate-500">
                🚨 For immediate life-threatening emergencies, call 911 or your
